...
if __name__ == "__main__":
    ...
    label_to_nl(f"build/{project_name}.nes.labels", f"build/{project_name}.nes.ram.nl", 0x0000, 0x7FF)
    label_to_nl(f"build/{project_name}.nes.labels", f"build/{project_name}.nes.0.nl", 0x8000, 0xBFFF)
    label_to_nl(f"build/{project_name}.nes.labels", f"build/{project_name}.nes.1.nl", 0xC000, 0xFFFF)
